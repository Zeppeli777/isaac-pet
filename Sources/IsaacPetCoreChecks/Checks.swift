...
enum IsaacPetCoreChecks {
    ...
    static func main() async {
        ...
        check(AnimationCatalog.verticalWalkingColumns == 8, "vertical walking columns")
        ...
        check(AnimationCatalog.verticalWalkingSpec(for: .down).frameCount == 8, "down walking frame count")
